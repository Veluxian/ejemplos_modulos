...
def run():
    ...
    # al hacer la siguiente linea de codigo, se le suma a un diccionario un dato nuevo dentro del mismo diccionario 
    # asi las personas mayores de 71 años se les da el valor old ? True 
    old_people = list(map(lambda worker: worker | {"old": worker["age"] > 70}, DATA))
    
    for worker in all_python_devs:
        print(worker + " python")
    
    for worker1 in all_platzi_workers:
        print(worker1 + " platzi")
